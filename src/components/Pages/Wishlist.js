    ...
    <div >
      {wishlist.length === 0 ? (
        <div className='wishlist-empty-page'>
          <img className="wishlist-empty-img" src="Assets/empty_wishlist.png" alt="" /><br /><br />
          <h2>Your wishlist is empty</h2>
          <p>Seems like you don't have wishlist here.</p>
          <p>Make a wish!!</p>
          <button className='empty-cart-button' onClick={() => createwish()}>Start Shopping</button>
        </div>
      ) : (
                  ...
                  <div className='wishlist-img'>
                    <div className='wishlist-des'>
                      <div className='product-dec'>
                        <div className='product-dec1'>{item.productName}</div>
                        <div className='product-dec2'>${item.productPrice}</div>
                      </div>
                    </div>
                    ...
                    <div className='wishlist-btn'>
                      <button className='wishlist-cart' onClick={() => addtocart(item)} >Add to cart</button>
                      <p className='wishlist-remove-btn' onClick={() => removeWishlistItem(item._id)}>REMOVE</p>
                    </div>
                  </div>
                ))
              }
