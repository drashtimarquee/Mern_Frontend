...
function Ottomans() {
    ...
    async function allottomans() {
        try {
            const response = await axios.get("http://localhost:1202/product/Ottomans");
    ...
    return (
        <div className='decor-page'>
            ...
            <div className='decor'>
                <img className='home-img' src='Assets/Furniture/Backottomans.webp' alt='ottomans' />
            </div>
            <Furniture />
            <h1>OTTOMANS</h1>
