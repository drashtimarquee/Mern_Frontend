...
function Basin() {
    ...
    async function allbasin() {
        try {
            const response = await axios.get("http://localhost:1202/product/Basin");
    ...
    return (
        <div className='decor-page'>
            <div className='decor'>
                <img className='home-img' src='Assets/Bathdecor/Bathasseback.webp' alt='backbasin' />
            </div>
            <Bathdecor />
            <h1>BASIN & ACCESEERIES</h1>
