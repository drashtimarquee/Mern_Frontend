            ...
            <div className='candlestand-decor'>
                <div className='candlestand-image'>
                    <div className='candlestand-image-column' >
                        <NavLink to='/Bathset'><img src="Assets/Bathdecor/Bathset/Bathset1.jpg" alt='bathset' /><p>price :  ₹ 2100.00</p></NavLink>
                    </div>
                    <div className='candlestand-image-column' >
                        <NavLink to='/Bathset'><img src="Assets/Bathdecor/Bathset/Bathset2.jpg" alt='bathset' /><p>price :  ₹ 2100.00</p></NavLink>
                    </div>
                    <div className='candlestand-image-column' >
                        <NavLink to='/Bathset'><img src="Assets/Bathdecor/Bathset/Bathset3.jpg" alt='bathset' /><p>price :  ₹ 2100.00</p></NavLink>
                    </div>
                    <div className='candlestand-image-column' >
                        <NavLink to='/Bathset'><img src="Assets/Bathdecor/Bathset/Bathset4.jpg" alt='bathset' /><p>price :  ₹ 2100.00</p></NavLink>
                    </div>
                    <div className='candlestand-image-column' >
                        <NavLink to='/Bathset'><img src="Assets/Bathdecor/Bathset/Bathset5.jpg" alt='bathset' /><p>price :  ₹ 2100.00</p></NavLink>
                    </div>
                    <div className='candlestand-image-column' >
                    ...
                    <div className='candlestand-image-column' >
                        <NavLink to='/Bathset'><img src="Assets/Bathdecor/Bathset/Bathset8.jpg" alt='bathset' /><p>price :  ₹ 2100.00</p></NavLink>
                    </div>
                    <div className='candlestand-image-column' >
                        <NavLink to='/Bathset'><img src="Assets/Bathdecor/Bathset/Bathset9.jpg" alt='bathset' /><p>price :  ₹ 2100.00</p></NavLink>
                    </div>
                    <div className='candlestand-image-column' >
                        <NavLink to='/Bathset'><img src="Assets/Bathdecor/Bathset/Bathset10.jpg" alt='bathset' /><p>price :  ₹ 2100.00</p></NavLink>
                    </div>
                    <div className='candlestand-image-column' >
                        <NavLink to='/Bathset'><img src="Assets/Bathdecor/Bathset/Bathset11.jpg" alt='bathset' /><p>price :  ₹ 2100.00</p></NavLink>
                    </div>
                    <div className='candlestand-image-column' >
                        <NavLink to='/Bathset'><img src="Assets/Bathdecor/Bathset/Bathset12.jpg" alt='bathset' /><p>price :  ₹ 2100.00</p></NavLink>
                    </div>
                    <div className='candlestand-image-column' >
                        <NavLink to='/Bathset'><img src="Assets/Bathdecor/Bathset/Bathset13.jpg" alt='bathset' /><p>price :  ₹ 2100.00</p></NavLink>
                    </div>
                    <div className='candlestand-image-column' >
                        <NavLink to='/Bathset'><img src="Assets/Bathdecor/Bathset/Bathset14.jpg" alt='bathset' /><p>price :  ₹ 2100.00</p></NavLink>
                    </div>
                </div>
            </div>
        </div>
