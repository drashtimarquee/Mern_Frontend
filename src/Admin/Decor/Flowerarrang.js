...
function Flowerarrang() {
    ...
    async function allflowerarrange() {
        try {
            const response = await axios.get("http://localhost:1202/product/Flowerarrang");
    ...
    return (
        <div className='decor-page'>
            <div className='decor'>
                <img className='home-img' src='Assets/Decor/Backflower.webp' alt='flower' />
            </div>
            <Decor />
            <h1>FAUX FLOWER ARRANGEMENTS</h1>
