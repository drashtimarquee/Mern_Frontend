...
function Fineporcelain() {
    ...
    async function allfineporcelain() {
        try {
            const response = await axios.get("http://localhost:1202/product/Fineporcelain");
    ...
    return (
        <div className='decor-page'>
            ...
            <Decor />
            <h1>FINE PORCELAIN FIGURINES</h1>
