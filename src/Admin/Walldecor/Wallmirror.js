...
function Wallmirror() {
    ...
    async function allmirror() {
        try {
            const response = await axios.get("http://localhost:1202/product/Wallmirror");
    ...
    return (
        <div className='decor-page'>
            <div className='decor'>
                <img className='home-img' src='Assets/Wall/Backmirror.webp' alt='backmirror' />
            </div>
            <Walldecor />
            <h1>MIRRORS</h1>
