...
function Wallvases() {
    ...
    async function allwallvases() {
        try {
            const response = await axios.get("http://localhost:1202/product/Wallvases");
    ...
    return (
        <div className='decor-page'>
            <div className='decor'>
                <img className='home-img' src='Assets/Wall/Backvases.webp' alt='wallvas' />
            </div>
            <Walldecor />
            <h1>WALL VASES</h1>
