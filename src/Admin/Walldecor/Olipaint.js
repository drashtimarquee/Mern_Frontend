...
function Olipaint() {
    ...
    async function allolipaint() {
        try {
            const response = await axios.get("http://localhost:1202/product/Olipaint");
    ...
    return (
        <div className='decor-page'>
            <div className='decor'>
                <img className='home-img' src='Assets/Wall/Backoil.webp' alt='oilwall' />
            </div>
            <Walldecor />
            <h1>MODERN OIL PAINTINGS</h1>
