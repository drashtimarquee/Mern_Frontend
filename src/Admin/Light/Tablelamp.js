...
function Tablelamp() {
    ...
    async function alltbllamp() {
        try {
            const response = await axios.get("http://localhost:1202/product/Tablelamp");
    ...
    return (
        <div className='decor-page'>
            <div className='decor'>
                <img className='home-img' src='Assets/Lighting/Backtable.webp' alt='backtbllmp' />
            </div>
            <Light />
            <h1>TABLE LAMPS</h1>
