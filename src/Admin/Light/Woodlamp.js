...
function Woodlamp() {
    ...
    async function allwoodlamp() {
        try {
            const response = await axios.get("http://localhost:1202/product/Woodlamp");
    ...
    return (
        <div className='decor-page'>
            <div className='decor'>
                <img className='home-img' src='Assets/Lighting/Back.webp' alt='woodlamp' />
            </div>
            <Light />
            <h1>WOOD LAMPS</h1>
