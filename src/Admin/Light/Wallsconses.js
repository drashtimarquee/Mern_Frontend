...
function Wallsconses() {
    ...
    async function allwallscenses() {
        try {
            const response = await axios.get("http://localhost:1202/product/Wallsconses");
    ...
    return (
        <div className='decor-page'>
            <div className='decor'>
                <img className='home-img' src='Assets/Lighting/Backwallsconses.webp' alt='wallsconses' />
            </div>
            <Light />
            <h1>WALL SCONSES</h1>
