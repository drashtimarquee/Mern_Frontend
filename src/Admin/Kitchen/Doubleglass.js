...
function Doubleglass() {
    ...
    async function alldouble() {
        try {
            const response = await axios.get("http://localhost:1202/product/Doubleglass");
    ...
    return (
        <div className='decor-page'>
            <div className='decor'>
                <img className='home-img' src='Assets/Kitchen/Back.webp' alt='backglass' />
            </div>
            <Kitchen />
            <h1>DOUBLE WALLED SERIES</h1>
