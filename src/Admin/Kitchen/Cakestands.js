...
function Cakestand() {
    ...
    async function allcakestand() {
        try {
            const response = await axios.get("http://localhost:1202/product/Cakestand");
    ...
    return (
        <div className='decor-page'>
            <div className='decor'>
                <img className='home-img' src='Assets/Kitchen/Backdesert.webp' alt='backdesert' />
            </div>
            <Kitchen />
            <h1>CAKE & TIERD STAND</h1>
