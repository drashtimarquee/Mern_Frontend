...
function Dinnerplates() {
    ...
    async function alldinnerplate() {
        try {
            const response = await axios.get("http://localhost:1202/product/Dinnerplates");
    ...
    return (
        <div className='decor-page'>
            <div className='decor'>
                <img className='home-img' src='Assets/Kitchen/Backdinner.webp' alt='backplates' />
            </div>
            <Kitchen />
            <h1>DINNER PLATES</h1>
