...
function Newdecor() {
    ...
    async function allnewdecor() {
        try {
            const response = await axios.get("http://localhost:1202/product/New Decor");
    ...
    return (
        <div className='decor-page'>
            <div className='decor'>
                <img className='new-home-img' src='Assets/Backnewdecor.webp' alt='backnew' />
            </div>
            <Newarrive />
            <h1>NEW DECOR</h1>
